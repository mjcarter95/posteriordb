...
def transformed_data(*, N, weight, diam1, diam2, canopy_height,
    ...
    return {'log_weight': log_weight, 'log_diam1': log_diam1, 'log_diam2':
        log_diam2, 'log_canopy_height': log_canopy_height,
...
def model(*, N, weight, diam1, diam2, canopy_height, total_height, density,
    ...
    observe('_log_weight__1', normal(beta__[1 - 1] + beta__[2 - 1] *
        log_diam1 + beta__[3 - 1] * log_diam2 + beta__[4 - 1] *
        log_canopy_height + beta__[5 - 1] * log_total_height + beta__[6 - 1
        ] * log_density + beta__[7 - 1] * group, sigma), log_weight)


def parameters_info(*, N, weight, diam1, diam2, canopy_height, total_height,
    density, group, log_weight, log_diam1, log_diam2, log_canopy_height,
    log_total_height, log_density):
