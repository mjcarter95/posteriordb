...
def transformed_data(*, N, switched, dist, arsenic):
    ...
    x = transpose(array([dist100, arsenic, inter], dtype=dtype_float), 0, 1)
    return {'dist100': dist100, 'inter': inter, 'x': x}


def model(*, N, switched, dist, arsenic, dist100, inter, x):
...
def parameters_info(*, N, switched, dist, arsenic, dist100, inter, x):
