...
def transformed_data(*, N, switched, dist, arsenic, assoc, educ):
    ...
    x = transpose(array([c_dist100, c_arsenic, da_inter, assoc, educ4],
        dtype=dtype_float), 0, 1)
    return {'c_dist100': c_dist100, 'c_arsenic': c_arsenic, 'da_inter':
        da_inter, 'educ4': educ4, 'x': x}
