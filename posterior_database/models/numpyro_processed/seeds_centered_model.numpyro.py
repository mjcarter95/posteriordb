...
def model(*, I, n, N, x1, x2, x1x2):
    ...
    c = sample('c', improper_uniform(shape=[I]))
    sigma = sample('sigma', lower_constrained_improper_uniform(0, shape=[]))
    b = c - mean_vector(c)
    observe('_alpha0__1', normal(array(0.0, dtype=dtype_float), array(1.0,
        dtype=dtype_float)), alpha0)
    observe('_alpha1__2', normal(array(0.0, dtype=dtype_float), array(1.0,
        dtype=dtype_float)), alpha1)
    observe('_alpha2__3', normal(array(0.0, dtype=dtype_float), array(1.0,
        dtype=dtype_float)), alpha2)
    observe('_alpha12__4', normal(array(0.0, dtype=dtype_float), array(1.0,
        dtype=dtype_float)), alpha12)
    observe('_sigma__5', cauchy(0, 1), sigma)
    observe('_c__6', normal(array(0.0, dtype=dtype_float), sigma), c)
