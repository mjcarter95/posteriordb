...
def model(*, N, weight, diam1, diam2, canopy_height, total_height, density,
    ...
    observe('_weight__1', normal(beta__[1 - 1] + beta__[2 - 1] * diam1 + 
        beta__[3 - 1] * diam2 + beta__[4 - 1] * canopy_height + beta__[5 - 
        1] * total_height + beta__[6 - 1] * density + beta__[7 - 1] * group,
        sigma), weight)
