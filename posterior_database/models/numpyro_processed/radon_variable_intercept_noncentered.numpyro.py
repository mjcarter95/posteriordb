...
def generated_quantities(*, J, N, county_idx, floor_measure, log_radon,
    alpha_raw, beta__, mu_alpha, sigma_alpha, sigma_y):
    alpha = mu_alpha + sigma_alpha * alpha_raw
    return {'alpha': alpha}
...
def map_generated_quantities(_samples, *, J, N, county_idx, floor_measure,
    ...
    def _generated_quantities(alpha_raw, beta__, mu_alpha, sigma_alpha, sigma_y
        ...
        return generated_quantities(J=J, N=N, county_idx=county_idx,
            floor_measure=floor_measure, log_radon=log_radon, alpha_raw=
            alpha_raw, beta__=beta__, mu_alpha=mu_alpha, sigma_alpha=
            sigma_alpha, sigma_y=sigma_y)
...
def parameters_info(*, J, N, county_idx, floor_measure, log_radon):
    return {'alpha_raw': {'shape': [J]}, 'beta': {'shape': []}, 'mu_alpha':
