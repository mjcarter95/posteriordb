...
def model(*, n_dogs, n_trials, y):
    ...
    def _fori__1(j, _acc__2):
        ...
        def _fori__5(t, _acc__6):
            p = _acc__6
            p = p.at[j - 1, t - 1].set(beta__[1 - 1] + beta__[2 - 1] *
                n_avoid[j - 1, t - 1] + beta__[3 - 1] * n_shock[j - 1, t - 1])
            return p
    ...
    def _fori__8(i, _acc__9):
        ...
        def _fori__10(j, _acc__11):
            observe(f'_y__{j}__{i}__12', bernoulli_logit(p[i - 1, j - 1]),
                y[i - 1, j - 1])
            return None
...
def generated_quantities(*, n_dogs, n_trials, y, beta__):
    ...
    def _fori__13(j, _acc__14):
        ...
        return n_avoid, n_shock, p
    n_avoid, n_shock, p = lax_fori_loop(1, n_dogs + 1, _fori__13, (n_avoid,
        n_shock, p))
