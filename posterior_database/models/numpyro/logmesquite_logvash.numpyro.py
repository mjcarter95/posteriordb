...
def model(*, N, weight, diam1, diam2, canopy_height, total_height, group,
    ...
    observe('_log_weight__1', normal(beta__[1 - 1] + beta__[2 - 1] * log_canopy_volume + beta__[
                                     ...
                                     4 - 1] * log_canopy_shape + beta__[
                                     5 - 1] * log_total_height + beta__[
                                     6 - 1] * group, sigma), log_weight)

def parameters_info(*, N, weight, diam1, diam2, canopy_height, total_height,
                       group, log_weight, log_canopy_volume, log_canopy_area,
                       log_canopy_shape, log_total_height):
