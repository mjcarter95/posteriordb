...
def transformed_data(*, N, switched, dist, arsenic, educ):
    ...
    c_educ4 = true_divide((educ - mean_vector(educ)), array(4.0, dtype=dtype_float))
    ...
    return { 'c_dist100': c_dist100, 'c_arsenic': c_arsenic,
             'c_educ4': c_educ4, 'da_inter': da_inter, 'de_inter': de_inter,
             'ae_inter': ae_inter, 'x': x }

def model(*, N, switched, dist, arsenic, educ, c_dist100, c_arsenic, c_educ4,
             da_inter, de_inter, ae_inter, x):
    # Parameters
