...
def convert_inputs(inputs):
    ...
    return { 'N': N, 'partyid7': partyid7, 'real_ideo': real_ideo,
             'race_adj': race_adj, 'educ1': educ1, 'gender': gender,
             'income': income, 'age_discrete': age_discrete }
...
def transformed_data(*, N, partyid7, real_ideo, race_adj, educ1, gender,
    ...
    def _fori__1(n, _acc__2):
        ...
        age30_44 = ops_index_update(age30_44, ops_index[n - 1], age_discrete[
        n - 1] == 2)
        age45_64 = ops_index_update(age45_64, ops_index[n - 1], age_discrete[
        n - 1] == 3)
        age65up = ops_index_update(age65up, ops_index[n - 1], age_discrete[
        n - 1] == 4)
...
def model(*, N, partyid7, real_ideo, race_adj, educ1, gender, income,
    ...
    # Model
    observe('_partyid7__3', normal(beta__[1 - 1] + beta__[2 - 1] * real_ideo + beta__[
                                   3 - 1] * race_adj + beta__[4 - 1] * age30_44 + beta__[
                                   5 - 1] * age45_64 + beta__[6 - 1] * age65up + beta__[
                                   7 - 1] * educ1 + beta__[8 - 1] * gender + beta__[
                                   9 - 1] * income, sigma), partyid7)
